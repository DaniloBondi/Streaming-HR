...
LANGS = {
    "🇮🇹 ITA": {
        ...
        "fc_diff": "FCmax - FCmin",
        "credits": "**Smartphone app:** App personalizzata creata con Google AI Studio e GitHub Copilot | **Repository:** GitHub | **Web app:** framework Streamlit",
    ...
    "🇬🇧 ENG": {
        ...
        "fc_diff": "HRmax - HRmin",
        "credits": "**Smartphone app:** Custom app created with Google AI Studio and GitHub Copilot | **Repository:** GitHub | **Web app:** framework Streamlit",
        "creator": "**Creator:** Danilo Bondi",
